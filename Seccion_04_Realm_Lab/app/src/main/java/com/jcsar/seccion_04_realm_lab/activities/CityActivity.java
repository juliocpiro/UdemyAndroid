package com.jcsar.seccion_04_realm_lab.activities;
...
import com.jcsar.seccion_04_realm_lab.R;
import com.jcsar.seccion_04_realm_lab.adapters.CityAdapter;
...
public class CityActivity extends AppCompatActivity implements RealmChangeListener<RealmResults<City>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CityAdapter(cities, R.layout.recycler_view_item
                , new CityAdapter.OnItemClickListener() {
                    @Override
